...
function config.nvim_treesitter()
    ...
    vim.api.nvim_create_autocmd("FileType", {
        pattern = { "c", "cpp", "lua", "bash", "go", "gomod", "json", "yaml", "latex", "make", "python", "rust", "html", "javascript", "typescript", "vue", "css", "markdown", "markdown_inline" },
        callback = function(args)
            vim.treesitter.start()
            vim.wo.foldexpr = 'v:lua.vim.treesitter.foldexpr()'
            vim.wo.foldmethod = 'expr'
            vim.opt_local.indentexpr = "v:lua.require'nvim-treesitter.indent'.get_indent(v:lnum)"
        end,
    })
end
    ...
    dap.configurations.python = {
        {
            ...
            pythonPath = function()
                ...
                return global.python3_host_prog
            end,
        },
    }
end
